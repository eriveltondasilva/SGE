                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-6 col-sm-7 col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="birth_place" maxlength="50"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="city" maxlength="10"
                                                    pattern="[0-9]{1}.[0-9]{4}-[0-9]{3}" placeholder="0.000-000">
                                            </div>
                                        </div>
