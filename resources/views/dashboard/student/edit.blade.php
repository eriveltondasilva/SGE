            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        name="name" value="{{ $student->name }}" placeholder="Insira o nome..." autofocus required>
                    @error('name')
                ...
                <div class="form-row">
                    <div class="form-group col-6 col-sm-7 col-md-8">
                        ...
                        <input type="text" class="form-control" id="birth_place" name="birth_place"
                            value="{{ $student->birth_place }}" placeholder="Insira o local de nascimento...">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kin_name" name="kin_name"
                        value="{{ $student->kin_name }}" placeholder="Insira o nome do responsável...">
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md">
                        ...
                        <input list="kinship" class="form-control" id="kin_kinship" name="kin_kinship"
                            value="{{ $student->kin_kinship }}" placeholder="Insira o parentesco do responsável...">
                        <datalist id="kinship">
                            <option value="Mãe">
                            <option value="Pai">
                            <option value="Tia">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address_street" name="address_street"
                        value="{{ $student->address_street }}" placeholder="Av. São Francisco de Assis, nº 100...">
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="address_neighborhood"
                            name="address_neighborhood" value="{{ $student->address_neighborhood }}"
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control" id="address_city" name="address_city"
                            value="{{ $student->address_city }}" placeholder="Insira a cidade do aluno...">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="address_cep">CEP:</label>
                        <input type="text" class="form-control js-cep" id="address_cep" name="address_cep"
                            value="{{ $student->address_cep }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control" id="address_state" name="address_state"
                            value="{{ $student->address_state }}" placeholder="Insira o Estado do aluno...">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="nationality">Nacionalidade:</label>
                        <input type="text" class="form-control" id="nationality" name="nationality"
                            value="{{ $student->nationality }}" placeholder="Insira a nacionalidade do aluno...">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="gov_benefits" name="gov_benefits"
                        value="{{ $student->gov_benefits }}" placeholder="Insira benefícios do governo...">
                </div>
