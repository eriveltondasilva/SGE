    ...
    <div class="col-sm-8 m-auto pt-3">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div>
                    <a href="{{ route('teacher.edit', $teacher) }}" class="btn btn-sm btn-primary px-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="rg" value="{{ $teacher->rg }}" readonly>
                </div>

                <div class="form-group col-md-6">
                    <label for="cpf">CPF:</label>
                    <input type="text" class="form-control" id="cpf" value="{{ $teacher->cpf }}" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" value="{{ $teacher->email }}" readonly>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md">
                    ...
                    <input type="text" class="form-control" id="telephone" value="{{ $teacher->telephone }}"
                        readonly>
                </div>

                <div class="form-group col-sm">
                    <label for="birth_date">Data de Nasc.:</label>
                    <input type="date" class="form-control" id="birth_date" value="{{ $teacher->birth_date }}"
                        readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" id="gender_female" name="gender"
                        @checked($teacher->gender === 'F') @disabled($teacher->gender !== 'F')>
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" id="gender_male" name="gender"
                        @checked($teacher->gender === 'M') @disabled($teacher->gender !== 'M')>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="address_street" value="{{ $teacher->address_street }}"
                    readonly>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-8">
                    ...
                    <input type="text" class="form-control" id="address_city" value="{{ $teacher->address_city }}"
                        readonly>
                </div>

                <div class="form-group col-md-4">
                    <label for="address_cep">CEP:</label>
                    <input type="text" class="form-control" value="{{ $teacher->address_cep }}" readonly>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="nationality" value="{{ $teacher->nationality }}"
                        readonly>
                </div>
            </div>
