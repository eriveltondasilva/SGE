                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="full_name" name="full_name"
                                                value="{{ $teacher->full_name }}" placeholder="Insira o nome..."
                                                autofocus required>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm">
                                                ...
                                                <input type="date" class="form-control" id="birth_date"
                                                    name="birth_date" value="{{ $teacher->birth_date }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address_street"
                                                name="address_street" value="{{ $teacher->address_street }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="address_complement"
                                                    name="address_complement" value="{{ $teacher->address_complement }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="address_neighborhood"
                                                    ...
                                                    value="{{ $teacher->address_neighborhood }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="address_city"
                                                    name="address_city" value="{{ $teacher->address_city }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="address_state"
                                                    name="address_state" value="{{ $teacher->address_state }}"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="nationality"
                                                    name="nationality" value="{{ $teacher->nationality }}"
