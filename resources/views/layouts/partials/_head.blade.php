<head>
    ...
    <link rel="shortcut icon" href="{{ Vite::icon('school.png') }}" type="image/x-icon" />
    ...
    @vite(['resources/css/adminlte.css', 'resources/css/main.css', 'resources/js/adminlte.js', 'resources/js/main.js', 'resources/js/vendors/bootstrap.bundle.js'])
