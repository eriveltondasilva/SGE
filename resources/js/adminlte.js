...
(function (global, factory) {
    ...
    var ControlSidebar = /*#__PURE__*/ (function () {
        ...
        _proto._fixScrollHeight = function _fixScrollHeight() {
            ...
            var positions = {
                bottom: Math.abs(
                    heights.window + $__default["default"](window).scrollTop() - heights.scroll
                ),
    ...
    $__default["default"](SELECTOR_DROPDOWN_MENU + " " + SELECTOR_DROPDOWN_TOGGLE).on(
        "click",
        function (event) {
            event.preventDefault();
    ...
    $__default["default"](SELECTOR_NAVBAR + " " + SELECTOR_DROPDOWN_TOGGLE).on(
        ...
        function (event) {
            ...
            if (
                $__default["default"](event.target).parent().hasClass(CLASS_NAME_DROPDOWN_SUBMENU)
            ) {
                return;
            }
    ...
    var IFrame = /*#__PURE__*/ (function () {
        ...
        _proto._setupListeners = function _setupListeners() {
            ...
            if (
                $__default["default"](SELECTOR_CONTENT_WRAPPER).hasClass(CLASS_NAME_IFRAME_MODE$1)
            ) {
    ...
    var SidebarSearch = /*#__PURE__*/ (function () {
        ...
        _proto.init = function init() {
            ...
            if (
                $__default["default"](SELECTOR_DATA_WIDGET$1).next(SELECTOR_SEARCH_RESULTS)
                    .length === 0
            ) {
            ...
            if (
                $__default["default"](SELECTOR_SEARCH_RESULTS).children(SELECTOR_SEARCH_LIST_GROUP)
                    .length === 0
            ) {
        ...
        _proto.toggle = function toggle() {
            if (
                $__default["default"](SELECTOR_DATA_WIDGET$1).parent().hasClass(CLASS_NAME_OPEN$2)
            ) {
                this.close();
            } else {
                this.open();
    ...
    var Toasts = /*#__PURE__*/ (function () {
        ...
        _proto.create = function create() {
            ...
            if (this._config.icon != null) {
                toastHeader.append(
                    $__default["default"]("<i />").addClass("mr-2").addClass(this._config.icon)
                );
            }

            if (this._config.title != null) {
                toastHeader.append(
                    $__default["default"]("<strong />").addClass("mr-auto").html(this._config.title)
                );
            }
            ...
            if (this._config.body != null) {
                toast.append(
                    $__default["default"]('<div class="toast-body" />').html(this._config.body)
                );
            }
    ...
    var Treeview = /*#__PURE__*/ (function () {
        ...
        _proto._setupListeners = function _setupListeners() {
            ...
            var elementId =
                this._element.attr("id") !== undefined ? "#" + this._element.attr("id") : "";
            $__default["default"](document).on(
                "click",
